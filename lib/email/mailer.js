...
export async function sendWelcomeEmail(userEmail, userName) {
  const subject = '¡Bienvenido a Sociedad de Tecnología Integral!';
  ...
  const html = `
    ...
    <html>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>¡Bienvenido a Sociedad de Tecnología Integral!</h1>
          </div>
          <div class="content">
            <p>Hola ${userName || 'Usuario'},</p>
            <p>Gracias por registrarte en Sociedad de Tecnología Integral, tu marketplace de confianza para productos tecnológicos reacondicionados.</p>
            ...
            <p>Saludos,<br><strong>El equipo de Sociedad de Tecnología Integral</strong></p>
          </div>
          <div class="footer">
            <p>© ${new Date().getFullYear()} Sociedad de Tecnología Integral. Todos los derechos reservados.</p>
          </div>
        </div>
      </body>
    </html>
  ...
  const text = `
¡Bienvenido a Sociedad de Tecnología Integral!

Hola ${userName || 'Usuario'},

Gracias por registrarte en Sociedad de Tecnología Integral, tu marketplace de confianza para productos tecnológicos reacondicionados.
...
Saludos,
El equipo de Sociedad de Tecnología Integral
  `;
...
export async function sendPasswordResetEmail(userEmail, resetToken) {
  ...
  const subject = 'Recuperación de contraseña - Sociedad de Tecnología Integral';
  ...
  const text = `
Recuperación de Contraseña - Sociedad de Tecnología Integral
