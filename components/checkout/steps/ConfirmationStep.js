...
const ConfirmationStep = ({ orderInfo, customerData, shippingData, selectedPaymentMethod }) => (
  <section className="confirmation">
    ...
    <p>
      Hemos registrado tu pedido. Sigue las instrucciones a continuación para completar tu pago.
    </p>
    ...
    <p className="confirmation__footer">
      Recibirás un correo de confirmación en <strong>{customerData.email}</strong> con todos los detalles de tu pedido.
    </p>
